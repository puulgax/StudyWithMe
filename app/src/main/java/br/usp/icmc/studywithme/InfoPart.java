...
public class InfoPart extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.part_map);
        ...
        gid = strings[0];
        TextView tv = (TextView) findViewById(R.id.part_text_materia);
        tv.setText(strings[1]);
        tv = (TextView) findViewById(R.id.part_text_data);
        tv.setText(strings[2]);
        tv = (TextView) findViewById(R.id.part_text_hora);
    ...
    private void participaGrupo(String idGrupo, String idUsuario){
        Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(InfoPart.this);
                if(retorno == 1) {
    ...
    private void loadPart(String idGrupo) {
        Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                TextView tv = (TextView) findViewById(R.id.part_part);
                String str = "";
